...
class UserStatus(object):
    def __init__(self, user_id: int, strict_redis):
        self.user_id = user_id
        self.__nodes_handler_entered: bool = False
        self.current_handler: Handler = None
        self.current_node_handler: Handler = None
        self.nodes_history: NodeIndexHistory = NodeIndexHistory(self.user_id, strict_redis)
        self.display_node_id: int = None
        self.__is_inside_current_node: bool = False
    ...
    def display_node(self, display_node: 'Node'):
        ...
        self.set_field('display_node_id', self.display_node_id)

    @property
    def is_inside_current_node(self):
        return self.__is_inside_current_node

    @is_inside_current_node.setter
    def is_inside_current_node(self, value: bool):
        self.__is_inside_current_node = value
        self.set_field('is_inside_current_node', value)

    @property
    def nodes_handler_entered(self):
        return self.__nodes_handler_entered

    @nodes_handler_entered.setter
    def nodes_handler_entered(self, value: bool):
        self.__nodes_handler_entered = value
        self.set_field('nodes_handler_entered', value)
